  ...
  if (!THREE) throw new Error('MeshLine requires three.js')
    ...
    class MeshLine extends THREE.BufferGeometry {
      ...
      // as you're creating an unnecessary geometry just to throw away
      // but exists to support previous api
      setGeometry(g, c) {
        // as the input geometry are mutated we store them
        // for later retrieval when necessary (declarative architectures)
        this._geometry = g;
      ...
      setPoints(points, wcb) {
        if (!(points instanceof Float32Array) && !(points instanceof Array)) {
          console.error('ERROR: The BufferArray of points is not instantiated correctly.');
          return;
        }
      ...
      process() {
        // Process the positions and other attributes as required
        // This is just a placeholder method; implement your actual processing logic here
        this.setAttribute('position', new THREE.Float32BufferAttribute(this.positions, 3));
        this.setAttribute('counter', new THREE.Float32BufferAttribute(this.counters, 1));
      }
    }
